  ...
  <div style="margin:0px 0px 12px 0;line-height:17px;">
    ...
    <div style="margin:0px 0px 0px 50px;">
      ...
      <a href="<?php echo $this->get_paged_threadlink($post->parent_id, "#postid-" . $post->id); ?>">
        <img title="<?php _e("Last post", "mingleforum"); ?>" style="vertical-align:middle;padding-left:10px;margin:0px 0 0px 0;border-radius:0px;box-shadow:none;" src="<?php echo $this->skin_url; ?>/images/post/lastpost.gif" />
      </a>
    </div>
  </div>
</li>
